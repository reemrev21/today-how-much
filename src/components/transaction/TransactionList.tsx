...
export function TransactionList({ ledgerId, date, onEdit }: TransactionListProps): React.JSX.Element {
  ...
  if (transactions.length === 0) {
    return (
      <View style={styles.empty}>
        <Text style={[styles.emptyText, { color: theme.mute2 }]}>거래 내역이 없습니다</Text>
      </View>
    );
  }
